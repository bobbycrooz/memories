...
const index = () => {
     return (
          <React.Fragment>
               <footer class='footer-bg text-gray-600 body-font mt-9 '>
                    ...
                    <div class='border-t border-gray-200'>
                         <div class='container px-5 py-8 flex flex-wrap mx-auto items-center'>
                              <div class='flex md:flex-nowrap flex-wrap justify-center items-end md:justify-start'>
                                   ...
                                   <button class='inline-flex text-white btn1-color border-0 py-2 px-6 focus:outline-none rounded'>
                                        Subscribe
                                   </button>
                                   <p class='text-gray-500 text-sm md:ml-6 md:mt-0 mt-2 sm:text-left text-center'>
                                        Get the latest update from our team
